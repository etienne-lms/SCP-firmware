 ...
 */
#define CLOCK_LIST \
	CLOCK_CELL(CLOCK_DEV_IDX_HSE, CK_HSE, "clk-hse"), \
	CLOCK_CELL(CLOCK_DEV_IDX_HSI, CK_HSI, "clk-hsi"), \
	CLOCK_CELL(CLOCK_DEV_IDX_CSI, CK_CSI, "clk-csi"), \
	CLOCK_CELL(CLOCK_DEV_IDX_LSE, CK_LSE, "clk-lse"), \
	CLOCK_CELL(CLOCK_DEV_IDX_LSI, CK_LSI, "clk-lsi"), \
	CLOCK_CELL(CLOCK_DEV_IDX_PLL1_P, PLL1_P, "pll1_p"), \
	CLOCK_CELL(CLOCK_DEV_IDX_PLL1_Q, PLL1_Q, "pll1_q"), \
	CLOCK_CELL(CLOCK_DEV_IDX_PLL1_R, PLL1_R, "pll1_r"), \
	CLOCK_CELL(CLOCK_DEV_IDX_PLL2_P, PLL2_P, "pll2_p"), \
	CLOCK_CELL(CLOCK_DEV_IDX_PLL2_Q, PLL2_Q, "pll2_q"), \
	CLOCK_CELL(CLOCK_DEV_IDX_PLL2_R, PLL2_R, "pll2_r"), \
	CLOCK_CELL(CLOCK_DEV_IDX_PLL3_P, PLL3_P, "pll3_p"), \
	CLOCK_CELL(CLOCK_DEV_IDX_PLL3_Q, PLL3_Q, "pll3_q"), \
	CLOCK_CELL(CLOCK_DEV_IDX_PLL3_R, PLL3_R, "pll3_r"), \
...
static const struct fwk_element *clock_config_desc_table(fwk_id_t module_id)
{
	...
	for (i = 0; i < FWK_ARRAY_SIZE(clock_cfg); i++)
...
const struct fwk_module_config config_stm32_clock = {
	.get_element_table = stm32_clock_desc_table,
};
